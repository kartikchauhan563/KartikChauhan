      ...
      <div class="row no-gutters">
        <div class="container">
          <div class="row">
            ...
            <center>
              <iframe
                src="https://docs.google.com/forms/d/e/1FAIpQLSeMoRZqWqBEJ8q9BBAW8Hrfx_jIpq8EhOUayTgDfMj_R7P7rQ/viewform?embedded=true"
                width="1000"
                height="818"
                frameborder="0"
                marginheight="5"
                  ...
                  <div class="col-lg-4 col-md-4">
                    ...
                    >
                      ...
                      <div class="">
                        ...
                        <p class="">
                          New Laxmi Nagar <br />
                          Bhramakumari Kumari Chowk <br />Gondia-441614 (MH)
                        </p>
                      </div>
                    </div>
                  </div>
